...
const IdentityProofingPage = () => {
  ...
  return (
    <div className="flex flex-col space-y-8">
      {/* Add ID to parent section for scroll detection */}
      <div id="identity-proofing-main">
        ...
        <div className="flex flex-col md:flex-row space-y-6 md:space-y-0 md:space-x-8">
          ...
          <div className="w-full md:w-1/2">
            ...
            <div className="mb-6">
              ...
              <p className="mb-2">
                This section defines the endpoints for the ID.me-based identity proofing flow for
                the RON (Remote Online Notarization) project.
              </p>
              <p>
